    ...
    return (
        <section className="max-w-2xl mx-auto p-6">
            ...
            <p className="mt-4 text-slate-700 leading-relaxed">
                I'm <strong>Rox</strong>, a backend developer for this website.
                I write Javascript and get our APIs working.
                I assist in coding, infrastructure, and deployment.
            </p>

            <p className="mt-4 text-slate-600">
                📧 <a
                href="mailto:rxdt@sfsu.edu"
